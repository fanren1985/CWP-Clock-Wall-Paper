...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadTasks() {
        ...
        tasks.sortBy { it.hour * 60 + it.minute }
        refreshUI()
    }
    ...
    /** 二次确认后删除任务 */
    private fun confirmDeleteTask(task: WallpaperTask) {
        MaterialAlertDialogBuilder(this)
            .setTitle(task.displayName)
            .setMessage("确定要删除这个定时任务吗？")
            .setPositiveButton("删除") { _, _ -> deleteTask(task) }
            .show()
    ...
    inner class TaskAdapter(
        private val items: List<WallpaperTask>,
        private val onDelete: (WallpaperTask) -> Unit
        ...
        inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
            ...
            fun bind(task: WallpaperTask) {
                ...
                tvImageName.text = task.displayName
                ...
                btnDelete.imageTintList = ColorStateList.valueOf(desaturateColor(Color.parseColor("#F44336")))
